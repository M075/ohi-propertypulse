  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-1 flex-col justify-center px-4 pb-20 sm:py-10 sm:px-6 lg:flex-none lg:px-20 xl:px-24 sm:bg-white dark:sm:bg-zinc-950 relative z-10">
